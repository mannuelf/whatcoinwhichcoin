...
class Resolver {
  ...
  resolveModule(path$$1) {
    try {
      return Module._resolveFilename(path$$1, {
  ...
  requireModule(path$$1, { esm: esm$$1, useESM = esm$$1, alias, isAlias = alias, intropDefault } = {}) {
    ...
    // Try to resolve path
    try {
      resolvedPath = this.resolvePath(path$$1, { isAlias });
    } catch (e) {
      lastError = e;
    }
